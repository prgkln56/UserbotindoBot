    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                ...
                [InlineKeyboardButton(text="❓ Help", url="https://t.me/{}?start=help".format(context.bot.username)), InlineKeyboardButton(text="💖 Donate", url="https://www.paypal.me/MoveAngel")]])
